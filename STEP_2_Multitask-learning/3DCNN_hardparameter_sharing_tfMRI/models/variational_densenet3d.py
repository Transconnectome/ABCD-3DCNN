...
from bayesian_torch.layers import Conv3dReparameterization
...
#(ref) pytorch-bayesian (model): https://github.com/IntelLabs/bayesian-torch/bayesian_torch/models/bayesian/resnet_variational.py
...
class _DenseLayer(nn.Module):
    ...
    def __init__(self, 
        ...
        self.add_module('conv1', Conv3dReparameterization(num_input_features, 
                                               bn_size * growth_rate, 
                                               kernel_size=1, 
                                               stride=1, 
                                               bias=False,
        ...
        self.add_module('conv2', Conv3dReparameterization(bn_size * growth_rate, 
                                               growth_rate, 
                                               kernel_size=3, 
                                               stride=1, 
                                               padding=1,
...
class _Transition(nn.Module):
    ...
    def __init__(self, 
        ...
        self.add_module('conv', Conv3dReparameterization(num_input_features, num_output_features, kernel_size=1, stride=1, bias=False,
                                              prior_mean=prior_mean,
                                              prior_variance=prior_variance,
                                              posterior_mu_init=posterior_mu_init,
                                              posterior_rho_init=posterior_rho_init))
...
class DenseNet(nn.Module):
    ...
    def __init__(self, subject_data, args,
        ...
        self.conv_stem.add_module('conv0', Conv3dReparameterization(n_input_channels,
                                num_init_features,
        ...
        # Linear layer
        self.FClayers = self._make_fclayers(softmax=True)
    ...
    def _make_fclayers(self):
        ...
        for cat_label in self.cat_target:
            ...
            FClayer.append(nn.Sequential(LinearReparameterization(in_features=self.num_features,  
