...
import monai
from monai.transforms import AddChannel, Compose, RandRotate90, Resize, ScaleIntensity, ToTensor, RandAxisFlip, RandAffine
...
def loading_phenotype(phenotype_dir, args, study_sample='UKB', partitioned_dataset_number=None):
    if study_sample.find('UKB') != -1:
        subject_id_col = 'eid'
    elif study_sample.find('ABCD') != -1:
    ...
    if partitioned_dataset_number is not None: 
