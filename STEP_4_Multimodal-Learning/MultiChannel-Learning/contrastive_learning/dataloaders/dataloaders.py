...
if os.uname()[1] in ['node1', 'node3']:
    ...
    ABCD_data_dir['T1_MNI_resize128']= f'/scratch/connectome/jubin/data/1.ABCD/T1_MNI_resize128/'
    ABCD_data_dir['FA_MNI_resize128']= f'/scratch/connectome/jubin/data/1.ABCD/FA_MNI_resize128/'
