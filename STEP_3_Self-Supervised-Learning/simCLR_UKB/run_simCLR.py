...
from utils.utils import argument_setting_simCLR, CLIreporter, argument_setting_simCLR, save_exp_result, checkpoint_save, checkpoint_load
from dataloaders.dataloaders import loading_images, partition_dataset_simCLR
from dataloaders.preprocessing import preprocessing_cat, preprocessing_num
from envs.simCLR_experiments import *
import hashlib
import datetime
...
if __name__ == "__main__":
    ...
    partition = partition_dataset_simCLR(image_files,args)
    ## ====================================== ##
    ...
    # Run SSL Experiment
    setting, result = simCLR_experiment(partition, save_dir, deepcopy(args))
