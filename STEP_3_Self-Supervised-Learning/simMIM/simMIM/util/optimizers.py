# LARS: almost copy paste from https://github.com/noahgolmant/pytorch-lars/blob/master/lars.py
# LAMB: almost copy paste from https://github.com/cybertronai/pytorch-lamb/blob/master/pytorch_lamb/lamb.py
import math
import torch
from torch.optim.optimizer import Optimizer, required
from .utils import device_as
