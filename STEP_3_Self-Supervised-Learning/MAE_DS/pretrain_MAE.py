...
parser.add_argument("--path_drop",default=0,type=float,required=False,help='dropout rate of encoder attention block')
...
#### optim parameters ####
##########################
parser.add_argument("--optim",type=str,required=False,help='', choices=['Adam','AdamW','SGD', 'LARS', 'LAMB'])
parser.add_argument("--lr", default=1e-4,type=float,required=False,help='')
...
parser.add_argument("--locak_rank", type=int, default=0)
