...
def checkpoint_save(net, save_dir, epoch, args, current_result=None, previous_result=None, mode=None):
    ...
    if mode == 'pretrain':
        ...
        net.save_checkpoint(save_dir=checkpoint_dir, client_state=save_state)
...
def checkpoint_load(net, checkpoint_dir,  mode='pretrain'):
    if mode == 'pretrain':
        _, save_state = net.load_checkpoint(load_dir=checkpoint_dir)
