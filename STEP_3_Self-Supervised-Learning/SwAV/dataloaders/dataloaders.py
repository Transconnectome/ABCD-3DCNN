...
def partition_dataset_SwAV(imageFiles,args):
    """
    ...
    train_set = ImageDataset(image_files=images_train,transform=ContrastiveLearningViewGenerator(resize = args.resize, standard_n_views= args.nmb_standard_views, low_n_views=args.nmb_low_views)) # return of ContrastiveLearningViewGenerator is [image1, image2]
