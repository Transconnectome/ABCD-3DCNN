...
def applying_augmentation(img, args, mode='image_wise'):
    ...
    if 'RandAdjustContrast' in args.augmentation: 
        augmentation_list.append(RandAdjustContrast(prob = 0.5, gamma = (0.5, 4.5)))
    if 'RandGaussianSmooth' in args.augmentation: 
        augmentation_list.append(RandGaussianSmooth(sigma_x = (0.25, 1.5), sigma_y = (0.25, 1.5), sigma_z = (0.25, 1.5), prob = 0.5))
    if 'RandGibbsNoise' in args.augmentation: 
        augmentation_list.append(RandGibbsNoise(prob = 0.5))
